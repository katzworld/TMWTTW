...
//const apiReso = 'https://clock.imamkatz.com/address/'; //ens resolv returns a nice text
...
const totdeaths = document.getElementById("totdeaths");

async function setPage() {
    const fixed_list = await getDeathApi();
    if (fixed_list.length == 0) {
        totdeaths.innerText = `no deaths bullets are FREE? api reset`;
    } else {
